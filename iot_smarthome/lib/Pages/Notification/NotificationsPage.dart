...
// class NotificationSelectionController extends GetxController {
//   final selectedNotifications = <String>{}.obs;
//   final isSelectionMode = false.obs;
//   final currentTab = 0.obs; // 0: Tất cả, 1: Thông báo, 2: Lời mời
...
//     isSelectionMode.value = selectedNotifications.isNotEmpty;
//   }
// }
...
//   final selectionController = Get.put(NotificationSelectionController());
...
//       selectionController.currentTab.value = _tabController.index;
...
//     final selectedNotifications = selectionController.selectedNotifications.toList();
...
//     return AppBar(
//       title: Obx(() => selectionController.isSelectionMode.value 
//           ? Text(
//               'Đã chọn: ${selectionController.totalSelectedCount}',
//               style: TextStyle(
...
//               ),
//             )),
//       leading: Obx(() => selectionController.isSelectionMode.value
//           ? IconButton(
...
//                            color: isDark ? Colors.white : Color(0xFF0F172A)),
//                 onPressed: selectionController.totalSelectedCount > 0 
...
//     return StreamBuilder<List<UnifiedNotificationModel>>(
...
//     return StreamBuilder<List<UnifiedNotificationModel>>(
//       stream: notificationController.getDeviceAlertsStream(),
//       builder: (context, snapshot) {
        
//         if (snapshot.connectionState == ConnectionState.waiting) {
//           return _buildLoadingState(isDark);
//         } else if (snapshot.hasError) {
//           debugPrint("Error cmmmr ${snapshot.error.toString()}");
//           return _buildErrorState(isDark);
//         } else if (!snapshot.hasData || snapshot.data!.isEmpty) {
...
//     return StreamBuilder<List<UnifiedNotificationModel>>(
//       stream: notificationController.getInvitationsStream(),
//       builder: (context, snapshot) {
//         if (snapshot.connectionState == ConnectionState.waiting) {
//           return _buildLoadingState(isDark);
//         } else if (snapshot.hasError) {
...
//                 children: [
//                   Text(
//                     selectionController.isSelectionMode.value ? "Đang chọn" : "Danh sách",
//                     style: TextStyle(
//                       fontSize: 18,
...
//                   Text(
//                     selectionController.isSelectionMode.value 
//                       ? "${selectionController.totalSelectedCount} mục được chọn"
...
//                 ],
//               ),
//               if (!selectionController.isSelectionMode.value && unreadCount > 0)
//                 Container(
...
//         Obx(() => selectionController.isSelectionMode.value 
...
//         return Obx(() {
//           final isSelected = selectionController.isNotificationSelected(notification.id);

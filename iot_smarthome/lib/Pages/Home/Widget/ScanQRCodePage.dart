...
//       await _validateAndShowConfirmation(homeId, roomId, uid);
...
//   Future<void> _validateAndShowConfirmation(String homeId, String roomId, String uid) async {
...
//   // Xử lý chọn ảnh từ thư viện với qr_code_dart_scan 0.11.5
...
//         // Đọc QR code từ ảnh với phiên bản 0.11.5
//         final String? qrCode = await _scanQRCodeFromImage(File(image.path));
        
//         Navigator.pop(context); // Đóng dialog loading
        
//         if (qrCode != null && qrCode.isNotEmpty) {
//           // Xử lý QR code đã đọc được
//           await _processQRCode(qrCode);
//         } else {
//           // Không tìm thấy QR code, hiển thị dialog nhập thủ công
...
//   // Hàm đọc QR code thực tế từ ảnh với phiên bản 0.11.5
//   // Hàm đọc QR code thực tế từ ảnh với phiên bản 0.11.5
// // Hàm debug để xem API thực sự
// // Hàm đọc QR code thực tế từ ảnh với QRCodeDartScanView

// Future<String?> _scanQRCodeFromImage(File imageFile) async {
//   try {
//     print("Đang đọc QR code từ file: ${imageFile.path}");

//     // Dùng QRCodeTools để quét QR từ file ảnh
//     final result = await QrCodeToolsPlugin.decodeFrom(imageFile.path);

//     if (result != null && result.isNotEmpty) {
//       print("QR code đọc được: $result");
//       return result;
//     } else {
...
//     }
//   } catch (e) {
//     print("Lỗi đọc QR code từ file: $e");
//     return null;
//   }
// }
...
//                 Text(
//                   "Không thể đọc QR code từ ảnh. Vui lòng nhập mã thủ công:",
...
//                     hintText: '{"homeId": "abc", "roomId": "123", "expire": 123456789}',
...
//                     const SizedBox(height: 8),
//                     Text(
//                       "Đặt mã QR vào khung hình để quét và kết nối với phòng",
//                       textAlign: TextAlign.center,
//                       style: TextStyle(
//                         fontSize: 14,
//                         color: Colors.grey[700],
...
//   Widget _buildCornerDecoration(bool isLeft, bool isTop) {
//     return Container(
//       width: 40,
//       height: 40,
//       decoration: BoxDecoration(
